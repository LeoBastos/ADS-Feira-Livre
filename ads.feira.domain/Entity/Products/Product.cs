...
namespace ads.feira.domain.Entity.Products
{
    public sealed class Product : BaseEntity, IEquatable<Product>
    {
        ...
        public Product(string id, string storeId, string categoryId, string name, string description, string assets, decimal price, decimal? discountedPrice)
        {
        ...
        public static Product Create(string id, string storeId, string categoryId, string name, string description, string assets, decimal price, decimal? discountedPrice)
        {
            return new Product(id, storeId, categoryId, name, description, assets, price, discountedPrice);
        }

        public void Update(string id, string storeId, string categoryId, string name, string description, string assets, decimal price, decimal? discountedPrice)
        {
            ValidateDomain(id, storeId, categoryId, name, description, assets, price, discountedPrice);
        }
        ...
        private void ValidateDomain(string id, string storeId, string categoryId, string name, string description, string assets, decimal price, decimal? discountedPrice)
        {           
