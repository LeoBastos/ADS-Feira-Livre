...
{
    public sealed class CognitoUser : BaseEntity
    {
        private CognitoUser() { }

        public CognitoUser(int id, string email, string name, string description, string assets, bool tosAccept, bool privacyAccept, string roles)
        {
        ...
        public static CognitoUser Create(int id, string email, string name, string description, string assets, bool tosAccept, bool privacyAccept, string roles)
        {
            return new CognitoUser(id, email, name, description, assets, tosAccept, privacyAccept, roles);
        }

        public void Update(int id, string email, string name, string description, string assets, bool tosAccept, bool privacyAccept , string roles)
        {
            ValidateDomain(id, email, name, description, assets, tosAccept, privacyAccept, roles);
        }
        public void Remove()
        ...
        private void ValidateDomain(int id, string email, string name, string description, string assets, bool tosAccept, bool privacyAccept, string roles)
        {
