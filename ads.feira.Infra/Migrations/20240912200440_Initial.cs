        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assets = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    StoreOwnerPlan = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedeemedCouponsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRedeemedCoupons", x => new { x.AccountId, x.RedeemedCouponsId });
                    table.ForeignKey(
                        name: "FK_UserRedeemedCoupons_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRedeemedCoupons_Cupons_RedeemedCouponsId",
                        column: x => x.RedeemedCouponsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AvailableCuponsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AccountId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FavoriteStoresId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteStores", x => new { x.AccountId, x.FavoriteStoresId });
                    table.ForeignKey(
                        name: "FK_UserFavoriteStores_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteStores_Stores_FavoriteStoresId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AvailableCouponsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteStores_FavoriteStoresId",
                table: "UserFavoriteStores",
                column: "FavoriteStoresId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRedeemedCoupons_RedeemedCouponsId",
                table: "UserRedeemedCoupons",
                column: "RedeemedCouponsId");
        }
