...
{
    public class RemoveProductFromCuponCommandHandler : IRequestHandler<RemoveProductFromCuponCommand, Cupon>
    {
        private readonly ICuponRepository _cuponRepository;
        private readonly IProductRepository _productRepository;
        private readonly IUnitOfWork _unitOfWork;

        public RemoveProductFromCuponCommandHandler(ICuponRepository cuponRepository, IProductRepository productRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Cupon> Handle(RemoveProductFromCuponCommand request, CancellationToken cancellationToken)
        {
